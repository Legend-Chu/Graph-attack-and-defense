            ...
            for batch_x, _ in batch_loader:
                ...
                for train_batch in batch_x:
                    try:
                        ...
                        inj_feat, disc_score, masked_score_idx = model(target, one_order_nei, budget, feat,
                                                                       norm_a_target,
                                                                       node_emb,
                        ...
                        new_edge_index = gen_extend_edge_index(edge_index, adj_tensor, disc_score, masked_score_idx,
                                                               device)
